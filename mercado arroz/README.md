...
![Version](https://img.shields.io/badge/version-1.0.7.6-blue)
...
- **📊 Indicadores de Mercado** - Visualização de dados do mercado
  - 💵 **Cotação do Dólar (USD/BRL)** - **✨ Atualização automática em tempo real**
    - Integração com AwesomeAPI (gratuita e sem API key)
    - Atualização a cada 5 minutos
    - Variação percentual automática
    - Fallback para localStorage em caso de falha
  - ☁️ Clima Pelotas/RS - temperatura, probabilidade de chuva e condições
- **Gráfico de Vendas** - Últimos 6 meses (Chart.js)
- **🆕 Indústrias Ativas** - Página dedicada mostrando compradores disponíveis no mercado
  - Filtros funcionais: Todas, Ativas, Inativas
  - Status visual: Logo colorido (ativa) ou cinza (inativa)
  - Botão "Enviar Mensagem" apenas para indústrias ativas
  - Ícone dedicado no menu de navegação (sempre acessível)
- **Criar Oferta** - Formulário completo em múltiplos passos
- **Minhas Ofertas** - Gerenciamento de ofertas ativas
- **Negociações** - Acompanhamento de propostas com status (Pendente, Aceita, Rejeitada)
...
- **Painel de informações expansível** - Detalhes da oferta aparecem abaixo das mensagens ao clicar no botão "Sobre a Oferta"
...
### v1.0.4 - 10/03/2026
- 🏭 **Nova Funcionalidade: Indústrias Ativas**
  - Produtores podem ver quais indústrias estão ativas no mercado
  - Cards visuais com logo colorido (ativa) ou cinza (inativa)
  - Botão "Enviar Mensagem" apenas para indústrias ativas
  - Toggle no perfil da indústria para marcar status (ativo/inativo)
  - Salvamento automático no localStorage
  - Animação de pulso no ícone de status ativo

### v1.0.3.2 - 10/03/2026
- 🔧 **Corrigido**: Página de Negociações estava em branco, agora funciona completamente
- 📋 Lista completa de propostas recebidas com status (Pendente/Aceita/Recusada)
- ✅ Botões de ação: Aceitar, Fazer Contraoferta, Recusar, Conversar
- 🎨 Design com cores por status (amarelo, verde, vermelho)
- 🔍 Filtros por tipo de negociação

### v1.0.3.1 - 10/03/2026
- 🎯 **Layout Dashboard Corrigido**: Conteúdo agora aparece à direita da sidebar (não embaixo)
- 📐 Reduzido espaçamento entre cards de estatísticas (1.5rem → 1rem)

### v1.0.3 - 10/03/2026
- 🎨 **Novo Layout de Dashboard**: Gráficos agora aparecem empilhados verticalmente (um embaixo do outro)
- 📊 Cards de estatísticas sempre em 4 colunas no desktop
- 📈 Gráficos maiores (350px) para melhor visualização
- ✨ Visual mais limpo e organizado
- 📱 Responsividade aprimorada (4 cols → 2 cols → 1 col)

### v1.0.2 - 10/03/2026
- ✨ **Layout Vertical Completo**: Todas as seções da landing page agora aparecem uma embaixo da outra (vertical)
- 🔧 **Corrigido**: Seções que apareciam lado a lado agora fluem de cima para baixo
- 📐 Hero section com conteúdo centralizado e empilhado
- 🎯 Fluxo de leitura natural: Hero → Benefícios → Como Funciona → CTA → Footer
- 📱 Layout totalmente responsivo em todas as telas

### v1.0.1 - 10/03/2026
- ✨ **Nova UX no Chat**: Painel de informações da oferta agora se expande verticalmente (para baixo) ao invés de aparecer lateralmente
- 🎨 Botão "Sobre a Oferta" aprimorado com feedback visual claro
- 🔄 Transições suaves com animações melhoradas
- 📱 Melhor aproveitamento de espaço em telas menores
